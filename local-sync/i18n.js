...
const STRINGS = {
  ar: {
    ...
    pullModeMergeTitle: "دمج آمن (موصى به)",
    pullModeMergeDesc: "يُضيف فقط الجديد من الملف. لا يحذف أي تصنيف أو موقع موجود لديك أبدًا.",
    pullModeReplaceTitle: "استبدال كامل",
    pullModeReplaceDesc:
      "يجعل محتوى الملف هو المرجع الكامل، وينقل عمليات الحذف أيضًا — لكن أي إضافة محلية لم تُزامَن بعد قد تُفقد.",
    pullModeReplaceWarning: "استخدم هذا الخيار فقط إن كنت تعمل من متصفح واحد فعليًا في كل مرة.",
  ...
  en: {
    ...
    pullModeMergeTitle: "Safe merge (recommended)",
    pullModeMergeDesc: "Only adds what's new in the file. Never deletes any collection or site you already have.",
    pullModeReplaceTitle: "Full replace",
    pullModeReplaceDesc:
      "Makes the file's content the complete source of truth, carrying over deletions too — but any local addition that hasn't synced yet may be lost.",
    pullModeReplaceWarning: "Only use this if you genuinely work from a single browser at a time.",
